/*
 * Compile with: gcc -lm -o sixemulat2 sixemulat2.c
 */
...
void usage()
{
  printf("usage: ./sixemulat <mouse bus id> <mouse device id> <joystick bus id> <joystick device id>\n");
  exit(-1);
}
...
int main(int argc, char *argv[])
{
  ...
  sprintf(sixemu, "Ii:%d:%03d", dbid, did);
