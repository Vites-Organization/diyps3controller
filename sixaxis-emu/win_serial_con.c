 ...
 */
int serial_send(struct sixaxis_state *state)
{
  s_report_data data =
  { };
  int i;
   ...
   */
  data.X = clamp(0, state->user.axis[0][0] + mean_axis_value, max_axis_value);
  data.Y = clamp(0, state->user.axis[0][1] + mean_axis_value, max_axis_value);
  data.Z = clamp(0, state->user.axis[1][0] + mean_axis_value, max_axis_value);
  data.Rz = clamp(0, state->user.axis[1][1] + mean_axis_value, max_axis_value);
